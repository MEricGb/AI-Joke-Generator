...
Single-column scrollable layout that works at any screen size.
"""
...
class JokeGeneratorApp:
    ...
    def _create_widgets(self) -> None:
        """Create all UI widgets with scrollable single-column layout."""
        ...
        # Bind mousewheel/trackpad scrolling (macOS and Windows/Linux)
    ...
    def _on_mousewheel(self, event):
        ...
        if event.delta:
            # macOS trackpad has small deltas, mouse wheel has larger
    ...
    def _create_connection_section(self) -> None:
        """Create Ollama connection section."""
    ...
    def _create_input_section(self) -> None:
        ...
        # Mic button on separate row for visibility
        ...
        if not self.stt_engine:
            ...
            # Show error when clicking disabled mic button
    ...
    def _start_recording(self) -> None:
        ...
        self.mic_status.config(text="Speak now!")
    ...
    def _show_stt_error(self) -> None:
        """Show why microphone is not available."""
